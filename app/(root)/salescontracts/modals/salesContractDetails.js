    ...
    return (
        <div className="px-2 pb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1.5 pt-2">
                {/* Client */}
                <div className="lg:col-span-2 border border-[#EAE8F2] p-2 rounded-2xl">
                ...
                {/* Contract # */}
                <div className="border border-[#EAE8F2] p-2 rounded-2xl flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 mt-1.5">
                {/* Currency */}
                <div className="border border-[#EAE8F2] p-2 rounded-2xl flex items-center gap-3">
            ...
            {/* Materials */}
            <div className="border border-[#EAE8F2] p-2 rounded-2xl mt-1.5">
