      ...
      <Listbox value={selected} onChange={(e) => setSelection(e)}>
        <div className="relative">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-xl bg-[var(--bg-card)] py-1 responsiveText shadow-lg border border-[var(--bg-subtle)] focus:outline-none z-50 text-[0.75rem]">
