        ...
        datasets: [
            {
                label: 'Total Sales',
                data: data1,
                borderColor: '#DAD6E8', // rock-blue
                backgroundColor: 'transparent',
                borderWidth: 2.5,
                tension: 0.4,
                fill: false,
                pointRadius: 4,
                pointBackgroundColor: '#DAD6E8',
                pointBorderColor: '#fff',
                pointBorderWidth: 2,
                pointHoverRadius: 6,
                pointHoverBackgroundColor: '#DAD6E8',
            ...
            },
            {
                label: 'Total Revenue',
                data: data2,
                borderColor: '#1E1B39', // chathams-blue
                backgroundColor: 'transparent',
                borderWidth: 2.5,
                tension: 0.4,
                fill: false,
                pointRadius: 4,
                pointBackgroundColor: '#1E1B39',
                pointBorderColor: '#fff',
                pointBorderWidth: 2,
                pointHoverRadius: 6,
                pointHoverBackgroundColor: '#1E1B39',
                pointHoverBorderColor: '#fff',
                pointHoverBorderWidth: 2,
            },
        ]
    ...
    const options = {
        ...
        plugins: {
            ...
            tooltip: {
                ...
                titleColor: '#1E1B39', // port-gore
                bodyColor: '#8D8AA3', // regent-gray
                borderColor: '#F4F3F9', // selago
                borderWidth: 1,
                cornerRadius: 8,
                padding: 12,
                callbacks: {
...
export const GroupedBarChart = (data1, data2) => {
    const obj = {
        ...
        datasets: [
            {
                label: 'Total Income',
                backgroundColor: '#DAD6E8', // rock-blue
                data: data1,
                borderRadius: 4,
                borderSkipped: false,
                barPercentage: 0.7,
            ...
            {
                label: 'Total Outcome',
                backgroundColor: '#1E1B39', // chathams-blue
                data: data2,
                borderRadius: 4,
                borderSkipped: false,
                barPercentage: 0.7,
...
export const BarChart = (data, color) => {
    ...
    const options = {
        ...
        scales: {
            ...
            x: {
                ticks: { font: { size: 11 }, color: '#8D8AA3' },
                grid: {
                    display: false
                },
                border: {
