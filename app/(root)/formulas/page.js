												...
												<div className='min-w-[130px]'>
													...
													<div className='relative'>
														...
														<button
															...
															className="absolute right-1 top-1/2 -translate-y-1/2 h-6 w-6 flex items-center justify-center rounded-[6px] text-[var(--ink-muted)] hover:text-[var(--brand)] hover:bg-[var(--bg-subtle)] transition-colors"
														>
