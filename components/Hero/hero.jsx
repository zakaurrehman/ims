        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-left">
            ...
            >
              ...
              <span className="text-[11px] font-semibold tracking-wide uppercase text-[#F4F3F9]">
            ...
            <motion.p
              ...
              className="text-sm md:text-base text-[#F4F3F9] mb-6 leading-relaxed font-light max-w-lg"
            >
            ...
            >
              {heroStats.map((s) => (
                <span key={s} className="text-[11px] font-medium text-[#F4F3F9] rounded-full px-3 py-1 border border-white/20 bg-white/[0.07]">
                  {s}
                </span>
              ))}
            </motion.div>
            ...
            >
              <Link href="/signin">
                <span className="bg-white text-[var(--chathams-blue)] px-8 py-2.5 rounded-xl font-bold hover:bg-[#F4F3F9] transition-all shadow-lg cursor-pointer inline-block hover:scale-105 active:scale-95 text-sm">
                  Sign In
                </span>
              </Link>
              <a href="#modules">
                <span className="border border-[#EAE8F2]/60 text-white px-8 py-2.5 rounded-xl font-bold hover:bg-white/10 transition-all flex items-center gap-2 cursor-pointer hover:scale-105 active:scale-95 text-sm">
